...
module.exports = {
    ...
    SESSION: process.env.BIXBYMOWL_CODE === undefined ? '' : process.env.BIXBYMOWL_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.hizliresim.com/loUtAb.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    BIXBY_ALIVE: process.env.BIXBY_ALIVE === undefined ? 'HEY' : process.env.BIXBY_ALIVE,
    ALIVE_TWO: process.env.ALIVE_TWO === undefined ? 'Helo' : process.env.ALIVE_TWO,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? 'ZIYAN💫' : process.env.OWNER_NAME,
    ...
    BC: process.env.BROADCAST_NAME === undefined ? 'ꪶ͢ʙͥɪͭxᷤʙᷟʏͤ ᴍᴏᴡʟ' : process.env.BROADCAST_NAME,
    ...
    WHATSALIVE: process.env.ALIVE_BUTTON === undefined ? 'Hello' : process.env.ALIVE_BUTTON,
    BIXBYALIVE: process.env.BUTTON_TWO === undefined ? 'Hii' : process.env.BUTTON_TWO,
    ...
    BOTNAMEV2: process.env.BOT_NAME === undefined ? 'ꪶ͢ʙͥɪͭxᷤʙᷟʏͤ ᴍᴏᴡʟ' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'Bixby🎗️/💝/✨/📝' : process.env.CMD_LIST,
