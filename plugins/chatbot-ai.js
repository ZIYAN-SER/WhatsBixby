...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Bixby voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
Bixby.addCommand({ pattern: 'vtalk$', desc: vtalk_dsc,dontAddCommandList: true, fromMe: wk }, (async (message, match) => {
