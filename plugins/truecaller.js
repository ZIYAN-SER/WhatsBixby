...
Jsl({pattern: 'true ?(.*)', desc: 'Searches for number in truecaller!',use: 'search',fromMe: wk}, async (msg, query) => {
...
if (res == 'error') return await msg.sendReply("_Truecaller limit over! (50/50) Contact owner_")
